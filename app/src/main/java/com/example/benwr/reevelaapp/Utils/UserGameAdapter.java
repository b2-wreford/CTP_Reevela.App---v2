...
import com.example.benwr.reevelaapp.Games.games_activity_selectGAME;
...
public class UserGameAdapter extends RecyclerView.Adapter<UserGameAdapter.ViewHolder> {
    ...
    public UserGameAdapter(Context mContext, List<User> mUsers, boolean ischat) {  //boolean ischat
        this.mUsers = mUsers;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UserGameAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent messageintent = new Intent(mContext, games_activity_selectGAME.class);
                messageintent.putExtra("user_id", user.getUsername());
